...
\horrule{0.5pt} \\[0.4cm]
\huge \textbf{Assignment Title} \\[.5cm] % The assignment title
...
\textbf{ID} & 000000 \\[0.5cm]
\textbf{Course} & Course name \\
\textbf{Academic Year} & 20xx-20xy \\[0.5cm]
\textbf{Advisor} & Name Surname \\ %e.g. Simone Libutti, Giuseppe Massari
